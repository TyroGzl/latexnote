...
\datechange{2024/11/25}{添加内容}
\begin{change}
  \item 添加\fullref{sec:punctuations}
\end{change}

\datechange{2024/12/24}{添加问题}
\begin{change}
  \item 添加\fullref{subsec:figure-subcaption}
  \item 添加\fullref{subsec:figure-ieeeaccess}
\end{change}

\datechange{2025/02/04}{添加问题}
\begin{change}
  \item 添加\fullref{subsec:cline-colortbl-error}
\end{change}

\datechange{2025/03/28}{添加问题}
\begin{change}
  \item 添加\fullref{subsec:tabularx-center}
\end{change}
